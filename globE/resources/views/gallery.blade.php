            ...
            <div class="col-sm-8">
                ...
                <div class="row">
                    ...
                    @foreach($qItems as $qItem)
                        @for ($i = 0; $i < 1; $i++)
                    <div class="col-sm-4 gallery-page">

                        <a href="{{URL::to('/photo-album',$qItem->id)}}">
                            
                        <img src="{{Storage::disk('s3')->url($qItem->alct_image_path)}}" class="img-responsive img-thumbnail" alt="2018 Photo Album Category" title="{{$sTitles}}" width="260">
                            <span><strong class="margin-top10 gallery">{{$qItem->alct_name}}</strong>
                            </span>
                         </a>
                    </div>
                        @endfor
